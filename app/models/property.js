...
export default DS.Model.extend({
  ...
  tTitle: computed('i18n.locale', function() {
  ...
  primaryPhotoUrl: computed('photos','orderedPropertyPhotos', function() {
    var primaryPhotoUrl = this.get("orderedPropertyPhotos.firstObject.image.url") || "http://placehold.it/140x90?text=.";
    return primaryPhotoUrl;
  }),


  orderedPropertyPhotos: computed('photos','photos.[].number', function() {
